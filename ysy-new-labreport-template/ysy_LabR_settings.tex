...
\fancyhead[R]{\textcolor{fgrayblue}{电阻热噪声玻尔兹曼常量测量}} % 新的一种更简洁的设置，用哪个看自己喜好
% 自定义页脚内容
\fancyfoot[L]{\textcolor{fgrayblue}{杨舒云，戴鹏辉}}
...
\newcommand{\infoTable}[7]{
	\begin{flushleft}
		\Huge \textcolor{fgraygreen}{\textbf{#1}}
	\end{flushleft}
