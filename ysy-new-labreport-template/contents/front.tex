...
% 大标题
\begin{center}
	\huge \textbf{APL1-4 \quad 电子自旋共振实验\\Electron Spin Resonance Experiment (ESR)}
\end{center}
...
\textbf{【Safety】}	
\begin{enumerate}
	\item The pole gap has been adjusted before the instrument leaves the factory. It is best not to adjust it by yourself during the experiment to avoid deviating from the resonant magnetic field too much.
	\item After ensuring that the wiring is correct, turn on the power and adjust the excitation voltage slowly.
	\item The double T adapter and short-circuit piston should not be adjusted with force outside the thread range to avoid thread slippage.
	\item  Protect the Gauss meter probe to avoid bending and squeezing.
	\item  Handle the sample with care when using it, and remember to put it back in the sample box after use to avoid loss and damage.
	\item  After the experiment, adjust the excitation voltage and sweep voltage to zero, then turn off the power and restore all instruments to their original state.
\end{enumerate}	
