% 这个拓展适配于“基础物理实验报告模式”；
% 整个模版的设计由2019级学长石寰宇完成，将这个模版封装进这个半通用样式也借用了他的代码；
% 可以在https://huanyushi.github.io/posts/labreport-template/找到他开发的模版和他的其它非常好的内容；
% 排版规范参考：https://www.bilibili.com/video/BV1WrdkY3ECV
