...
Usage:
    ...
    >>> from ysy_plot_utils import ysy_settings, firefly_color_theme, plot
    >>> import matplotlib.pyplot as plt

    >>> # Apply custom plot settings
    >>> plt.rcParams.update(ysy_settings(dpi=150, color=True, marker=True))

    >>> # Generate firefly-themed colormap
    >>> cmap = firefly_color_theme(mode='colormap')

    >>> # Create a simple line plot
    >>> x = [0, 1, 2, 3]
    >>> y = [0, 1, 4, 9]
    >>> plot(x, y, legend_name='Quadratic', plot_title='Example Plot', x_label='X', y_label='Y')
...
xtick.labelcolor: 2e2e2e
ytick.labelcolor: 2e2e2e

# Background color: Base
figure.facecolor: f6f7fa
axes.facecolor: f6f7fa
savefig.facecolor: f6f7fa

# Edge color: Surface
axes.edgecolor: ccd0dd
legend.edgecolor: ccd0dd
xtick.color: ccd0dd
ytick.color: ccd0dd
patch.edgecolor: ccd0dd
hatch.color: ccd0dd
...
# Boxplots
boxplot.flierprops.color: a5aab3
boxplot.flierprops.markerfacecolor: a5aab3
boxplot.flierprops.markeredgecolor: a5aab3
boxplot.boxprops.color: a5aab3
boxplot.whiskerprops.color: a5aab3
boxplot.capprops.color: a5aab3
boxplot.medianprops.color: a5aab3
boxplot.meanprops.color: a5aab3
boxplot.meanprops.markerfacecolor: a5aab3
boxplot.meanprops.markeredgecolor: a5aab3
